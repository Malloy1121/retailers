...
// module
exports.push([module.i, "/* You can add global styles to this file, and also import other style files */\nbody {\n  margin: 0; }\n\n.dropdown-icon {\n  border: 5px solid black;\n  display: inline-block;\n  position: absolute;\n  top: calc(50% - 2px);\n  right: 8px;\n  background-color: transparent;\n  border-bottom-color: transparent;\n  border-right-color: transparent;\n  border-left-color: transparent; }\n\n.form-validator {\n  font-weight: bold;\n  color: red; }\n\nbutton[disabled] {\n  cursor: no-drop;\n  opacity: 0.7; }\n\n.btn-profile {\n  outline: none;\n  border: none;\n  background-color: #232f3e;\n  color: white;\n  border-radius: 5px;\n  height: 35px;\n  width: 100%; }\n  .btn-profile:active {\n    background-color: #3937b2; }\n\na,\na:link,\na:visited,\na:hover,\na:active {\n  text-decoration: none;\n  color: inherit; }\n\n.content {\n  width: 100%;\n  min-width: 1000px;\n  margin: 50px 0;\n  box-sizing: border-box; }\n\nbutton {\n  cursor: pointer; }\n\n.display-none {\n  display: none; }\n\n.dropdown-conatainer {\n  position: relative; }\n  .dropdown-conatainer:hover .dropdown-list {\n    display: block; }\n  .dropdown-conatainer .dropdown-list {\n    display: none;\n    list-style: none;\n    position: absolute;\n    background-color: white;\n    color: black;\n    border: 1px solid black;\n    padding: 10px 0;\n    margin: 0;\n    border-radius: 3px;\n    text-align: left;\n    height: auto;\n    top: calc(100% - 2px); }\n    .dropdown-conatainer .dropdown-list:before {\n      content: \"\";\n      position: absolute;\n      top: -9px;\n      left: 25%;\n      width: 0;\n      height: 0;\n      border-left: 10px solid transparent;\n      border-right: 10px solid transparent;\n      border-bottom: 10px solid white;\n      border-top: none; }\n    .dropdown-conatainer .dropdown-list li {\n      margin: 5px 0;\n      cursor: pointer;\n      background-color: white;\n      padding: 5px 25px;\n      white-space: nowrap; }\n      .dropdown-conatainer .dropdown-list li:hover {\n        background-color: lightgrey; }\n", ""]);
